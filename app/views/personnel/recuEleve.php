...
<body>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="row my-4">
            <div class="col-md-12 d-flex justify-content-between align-items-center">
                ...
                <div class="input-group search-container w-50">
                    ...
                    <input type="text" class="form-control" placeholder="Rechercher un personnel..."
        ...
        <!-- Modal Large -->
        <div class="modal fade" id="ajoutPersonnelModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="index.php?action=register" method="POST">
                                ...
                                <div class="error-message" style="color: red;"><?= htmlspecialchars($errorMessage) ?>
                                </div>
                                <?php endif; ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="telephone"
                                                placeholder="Entrez le numéro de téléphone" name="telephone" required>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="prenom"
                                                placeholder="Entrez le prénom" name="prenom" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="password"
                                                placeholder="Entrez le mot de passe" name="password" required>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="role" class="form-label">Poste <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label for="statut_compte" class="form-label">Statut du compte <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="id_salaire" class="form-label">ID Salaire <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label for="derniere_connexion" class="form-label">Date de prise de poste
                                                <span class="text-danger">*</span></label>
                                            <input type="date" class="form-control" id="derniere_connexion"
                                                name="derniere_connexion" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn" data-bs-toggle="modal"
                                        data-bs-target="#archiveModal<?= $p['id_personnel'] ?>">
                                        <i class="fas fa-archive" title="Archiver"></i>
                                    </button>

                                    <!-- Modal de confirmation d'archivage -->
                                    <div class="modal fade" id="archiveModal<?= $p['id_personnel'] ?>" tabindex="-1"
                                        aria-labelledby="archiveModalLabel<?= $p['id_personnel'] ?>" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Voulez-vous vraiment archiver <?= htmlspecialchars($p['prenom']) ?>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="index.php?action=archivePersonnel&id=<?= $p['id_personnel'] ?>"
                                                        class="btn btn-primary">Archiver</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Toast pour le message d'archivage réussi -->
                                        <div class="toast" id="archiveToast"
                                            style="position: absolute; top: 20px; right: 20px;" data-bs-autohide="true">
                                    ...
                                    <button type="button" class="btn" data-bs-toggle="modal"
                                        data-bs-target="#editModal<?= $p['id_personnel'] ?>">
                                        <i class="fas fa-edit" title="Modifier"></i>
                                    </button>
                                    <div class="modal fade" id="editModal<?= $p['id_personnel'] ?>" tabindex="-1"
                                        aria-labelledby="editModalLabel<?= $p['id_personnel'] ?>" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
            ...
            <nav aria-label="Pagination" class="d-flex justify-content-center">
                <ul class="pagination">
                    ...
                    <li class="page-item <?= ($page == $totalPages) ? 'disabled' : '' ?>">
                        <a class="page-link"
                            href="?action=listPersonnel&page=<?= min($totalPages, $page + 1) ?>">Suivant</a>
                    </li>
                </ul>
            </nav>
            <?php else: ?>
