    ...
    <div class="container-fluid px-4">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php foreach ($paiements Archives as $p): ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn" data-bs-toggle="modal"
                                data-bs-target="#desarchiveModal<?= $p['id_paiement'] ?>">
                                <i class="fas fa-undo" title="Désarchiver"></i>
                            </button>

                            <div class="modal fade" id="desarchiveModal<?= $p['id_paiement'] ?>" tabindex="-1"
                                aria-labelledby="desarchiveModalLabel<?= $p['id_paiement'] ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="index.php?action=listePaiementsArchives=<?= $p['id_paiement'] ?>"
                            ...
                            <button type="button" class="btn" data-bs-toggle="modal"
                                data-bs-target="#showModal<?= $p['id_paiement'] ?>">
                                <i class="fas fa-eye" title="Afficher"></i>
                            </button>
                            <div class="modal fade" id="showModal<?= $p['id_paiemnt'] ?>" tabindex="-1"
                                aria-labelledby="showModalLabel<?= $p['id_paiement'] ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
        ...
        <a href="index.php?action= listPaiement" class="btn btn-secondary">Retour</a>
