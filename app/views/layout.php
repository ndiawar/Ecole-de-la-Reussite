...
<nav class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="#">Rapport Financière</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white" href="#">Enseignants et Cours</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white" href="#">Examens et Résultats</a>
        </li>

        <!-- Menu déroulant pour Gestion des Inscriptions -->
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" href="#" id="dropdownInscription" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="#">Présences</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white" href="#">Rapports d'activités</a>
        </li>
    </ul>
</nav>
